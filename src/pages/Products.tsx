        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
          <div className="flex gap-4">
            <select className="px-4 py-2 rounded-lg border border-input bg-background">
              ...
              <option>{t('products.electronics')}</option>
              <option>{t('products.fashion')}</option>
              <option>{t('products.homeGarden')}</option>
            </select>
            <select className="px-4 py-2 rounded-lg border border-input bg-background">
              <option>{t('products.allMarketplaces')}</option>
              <option>{t('products.mercadoLivre')}</option>
              <option>{t('products.shopee')}</option>
              <option>{t('products.amazon')}</option>
            </select>
          </div>
          <Button>
